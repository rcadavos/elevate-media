      ...
      <main className="flex-1">
        <section className="relative overflow-hidden border-b border-border">
          ...
          >
            ...
            <div className="absolute bottom-0 right-[-10%] h-[28rem] w-[28rem] rounded-full bg-emerald-600/10 blur-3xl dark:bg-[#102620]/80" />
          ...
          <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-14 sm:px-6 sm:pb-24 sm:pt-20">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Button
                ...
                nativeButton={false}
                size="lg"
                className="px-6 py-3.5 text-sm font-semibold shadow-lg dark:bg-white dark:text-black dark:hover:bg-white/90"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-foreground/20 bg-card/90 px-6 py-3.5 text-sm font-semibold backdrop-blur-sm hover:bg-card dark:border-white/40 dark:bg-transparent dark:text-white dark:hover:bg-white/10"
              >
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:grid-cols-3 sm:gap-8 sm:px-6">
            {pillars.map((p) => (
              <div key={p.title} className="relative pl-4 sm:pl-5">
                <span
                  className="absolute left-0 top-1.5 h-[calc(100%-0.25rem)] w-0.5 rounded-full bg-gradient-to-b from-primary to-teal-600/70 opacity-90 dark:from-[#36f4a4] dark:to-teal-800/80"
                  aria-hidden
                />
        ...
        <section className="relative overflow-hidden border-t border-border bg-muted py-16 text-foreground dark:bg-gradient-to-br dark:from-[#102620] dark:via-[#061a1c] dark:to-[#000000] dark:text-white">
          <div
          ...
          <div className="relative mx-auto flex max-w-6xl flex-col items-start gap-8 px-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div className="max-w-xl">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base dark:text-white/80">
            ...
            <div className="flex w-full flex-col gap-3 sm:w-auto sm:min-w-[200px]">
              <Button
                ...
                nativeButton={false}
                size="lg"
                className="font-semibold shadow-lg dark:bg-white dark:text-black dark:hover:bg-white/90"
              >
                Create an account
              </Button>
              <Button
                ...
                variant="outline"
                size="lg"
                className="font-semibold dark:border-white/35 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
              >
